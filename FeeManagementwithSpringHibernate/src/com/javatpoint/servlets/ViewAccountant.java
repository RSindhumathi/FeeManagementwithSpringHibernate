...
public class ViewAccountant extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form action='ViewAccountantOrder' method='post'>");
	    out.println("<input type='submit' class='btn btn-default' value='Ascending order' name ='asc'/>");
	    out.println("<input type='submit' class='btn btn-default' value='Descending order' name ='dsc'/>");
